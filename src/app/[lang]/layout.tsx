  ...
  return (
    <UIProvider>
      ...
      */}
      ...
      {/* Apply font CSS variables + baseline typography to the app subtree */}
      <div
        suppressHydrationWarning
        className={`${merriweather.variable} ${libreBaskerville.variable} ${plusJakarta.variable} antialiased`}
      >
        {children}
      </div>
    </UIProvider>
