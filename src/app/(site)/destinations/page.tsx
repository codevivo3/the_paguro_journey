...
import { getRegionShortTitleIt } from '@/domain/worldRegions';
...
export default async function DestinationsPage({
  ...
  const destinations = countries.map((c) => {
    ...
    const regionName = getRegionShortTitleIt(regionSlug);
      ...
      <div className='mx-auto max-w-5xl space-y-10'>
        ...
        <header className='space-y-3'>
          ...
          <p className='t-page-subtitle'>
            Una mappa semplice dei luoghi che abbiamo esplorato — per ora guidata
            dai video, con storie e guide in arrivo.
          </p>
        </header>

        {/* Filters (URL-driven, server-safe) */}
        <DestinationsFilters destinations={visibleDestinations} searchParams={sp} />
